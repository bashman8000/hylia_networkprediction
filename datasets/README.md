...
IP Network Traffic Flows Dataset |The data presented here was collected in a network section from Universidad Del Cauca, Popayán, Colombia by performing packet captures at different hours, during morning and afternoon, over six days (April 26, 27, 28 and May 9, 11 and 15) of 2017. This dataset contains 87 features. Each instance holds the information of an IP flow generated by a network device i.e., source and destination IP addresses, ports, interarrival times, layer 7 protocol (application) used on that flow as the class, among others.|[LINK](https://www.kaggle.com/jsrojas/ip-network-traffic-flows-labeled-with-87-apps?select=Dataset-Unicauca-Version2-87Atts.csv)
Mininet SDN Dataset |This is a SDN specific data set generated by using mininet emulator and used for traffic classification by machine learning and deep learning algorithms.  The project start by creating ten topologies in mininet in which switches are connected to single Ryu controller.  Network simulation runs for benign TCP, UDP and ICMP traffic and malicious traffic which is the collection of TCP Syn attack, UDP Flood attack, ICMP attack. Total 23 features are available in the data set in which some are extracted from the switches  and others are calculated.|[LINK](https://data.mendeley.com/datasets/jxpfjc64kr/1)
Netflow Dataset |Machine Learning-Based NIDS Datasets: The Version of the datasets are made up of 8 limited NetFlow features, while the Version 2 is made up of 43 extended NetFlow features.|[LINK](https://staff.itee.uq.edu.au/marius/NIDS_datasets/)
CAIDA Anonymized Network Traces Dataset |Statistics for the 2002/2003 OC48 and the monthly OC192 traces can be found in the tables below. Additional information can be found on the Statistical information for the CAIDA Anonymized Internet Traces page. On the OC192 monitors an hour-long trace is recorded once a month, usually (but not always) on the third Thursday of each month between 13:00 UTC and 14:00 UTC.|[LINK](https://www.caida.org/catalog/datasets/trace_stats/)
